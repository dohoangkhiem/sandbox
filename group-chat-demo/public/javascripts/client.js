function initUI() {
  $('#chat-tabs-container').tabs().addClass( "ui-tabs-vertical ui-helper-clearfix");
  $('#chat-tabs-container li').removeClass( "ui-corner-top" ).addClass( "ui-corner-left" ); 
}
